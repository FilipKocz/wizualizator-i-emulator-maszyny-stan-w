...
Cel projektu
Projekt powstał jako narzędzie edukacyjne i inżynierskie, pozwalające na graficzne modelowanie procesów logicznych oraz natychmiastową weryfikację ich poprawności.
Funkcjonalności
